...
export default function BookOnlinePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#D9D9DD] dark:bg-[#121212]">
      <SafeAreaHeader title="Онлайн запись" showBackButton backUrl="/" className="bg-[#262626]" />
      ...
      <main className="flex-1 p-4 pb-20 pt-[calc(60px+env(safe-area-inset-top))]">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {selectedTimeSlot && selectedShop && !bookedSlot && (
            <Card className="bg-[#E3F2FD] dark:bg-[#1E3A8A]/20 border-[#009CFF]">
              <CardContent className="p-4">
                <h4 className="font-bold text-[#1F1F1F] dark:text-white mb-2">Детали записи</h4>
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Услуга:</span>
                    <span className="font-medium text-[#1F1F1F] dark:text-white">Быстрая запись</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Магазин:</span>
