        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <Card className="bg-green-50 border-green-500">
            <CardContent className="p-6 text-center">
              ...
              <h1 className="text-2xl font-bold text-green-700 mb-2">Запись подтверждена!</h1>
          ...
          <Card className="bg-white">
            <CardContent className="p-6">
              <h2 className="text-lg font-bold text-gray-900 mb-4">Детали записи</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Контактная информация</p>
          ...
          <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
            <h2 className="text-lg font-bold mb-4 text-gray-900">Заказанные услуги</h2>
          ...
          {/* Что дальше */}
          <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
            <h2 className="text-lg font-bold mb-3 text-gray-900">Что дальше?</h2>
          ...
          <Card className="bg-gray-50">
            <CardContent className="p-4 text-center">
              <p className="text-sm text-gray-600 mb-2">Есть вопросы по записи?</p>
