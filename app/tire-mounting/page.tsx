      ...
      <main className="flex-1 pt-[calc(60px+env(safe-area-inset-top)+1rem)] relative">
        ...
        <div className="px-4 py-6 bg-[#2A2A2A] text-white">
          <div className="bg-[#121212] rounded-lg p-4 space-y-4">
            <div className="mb-4">
              <label className="block text-sm font-medium mb-2 text-white">Мой гараж</label>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-[#2A2A2A] rounded-lg p-4">
                <h3 className="text-lg font-bold mb-3">Комплекс шиномонтажных работ</h3>
                {(() => {
                    ...
                    <div className={isServiceSelectionDisabled ? "opacity-50 pointer-events-none" : ""}>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-3">
                          <div
                            className="flex-1 rounded-lg px-3 py-2 text-center flex flex-col items-center justify-center bg-[#121212] text-white cursor-pointer hover:bg-[#1a1a1a] transition-all duration-200"
                            onClick={() => {
                              setServiceQuantities((prev) => ({
                                ...prev,
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <button
                              ...
                              disabled={isServiceSelectionDisabled}
                              className="w-12 h-12 bg-[#484b51] text-white rounded-lg flex items-center justify-center hover:bg-[#5A5D63] focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed text-xl font-bold"
                            >
                              -
                            </button>
                          </div>
              ...
              <div className="bg-[#2A2A2A] rounded-lg p-4">
                <div className="flex justify-between items-center mb-3">
                  <h3 className="text-lg font-bold">Общие услуги</h3>
                  <button
                    onClick={() => {
                      ...
                      <div className="space-y-2">
                        {Object.entries(additionalServices).map(([key, name]) => (
                          <div key={key} className="flex items-center gap-2">
                            <div className="flex-1 rounded-lg px-3 py-2 bg-[#121212] text-white">
                              {name}
                              {diameter && (
                            ...
                            <button
                              ...
                              disabled={isServiceSelectionDisabled}
                              className="w-10 h-10 bg-[#484b51] text-white rounded-lg flex items-center justify-center hover:bg-[#5A5D63] focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                              -
                            </button>
                            <div className="w-10 h-10 bg-[#1A1A1A] text-white rounded-lg flex items-center justify-center text-sm font-medium">
              ...
              <div className="pt-4 flex gap-4 items-stretch">
                <div className="w-3/5 bg-[#2A2A2A] rounded-lg p-3">
                  <div className="mb-3">
                  ...
                  <div className="border-t border-gray-600 mt-3 pt-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-xl font-bold text-blue-400">{Math.round(totalPrice)} ₽</span>
                    </div>
                  </div>
                </div>
                <div className="w-2/5 flex flex-col gap-3">
                  <input
                    ...
                    className={`w-full bg-[#2A2A2A] text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 border text-center ${
                      promoApplied ? "border-green-500" : "border-gray-600"
                    }`}
                  />
                  {promoApplied && (
                    <div className="text-green-400 text-xs text-center">Промокод "ЖИЗНЬ" применен! Скидка 15%</div>
                  )}
                  <button
        ...
        <div className="px-4 py-6 bg-[#1A1A1A] text-white">
          ...
          <div className="mb-6">
            <div className="w-full aspect-video bg-[#2A2A2A] rounded-lg overflow-hidden flex items-center justify-center">
      ...
      {showCarTypeInfoModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg max-w-md w-full max-h-[90vh] overflow-auto">
            <div className="p-4 border-b dark:border-gray-700 flex justify-between items-center bg-[#333333]">
              <h3 className="font-bold text-lg text-white">Типы автомобилей</h3>
              <button onClick={() => setShowCarTypeInfoModal(false)} className="text-gray-400 hover:text-gray-200">
                ✕
              </button>
            </div>
            <div className="p-4 bg-[#333333] text-white space-y-4">
              <div className="bg-[#121212] rounded-lg p-3">
                <div className="mb-2">
                  <div className="w-full h-32 bg-blue-500 rounded-lg flex items-center justify-center overflow-hidden mb-2">
                    <Image
                  ...
                  <div>
                    <div className="flex items-center justify-between">
                      <h4 className="font-medium">Легковой авто</h4>
                      <span className="text-xs text-blue-400 cursor-pointer hover:text-blue-300">все авто</span>
                    </div>
                    <p className="text-xs text-gray-400">Mercedes E-Class, BMW 3 Series, Toyota Camry, Audi A4...</p>
                  </div>
                </div>
              </div>
            </div>
